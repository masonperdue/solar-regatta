...
void loop(void)
{
  ...
  Serial.println("-----------------------------------------------------------");
  Serial.print("Battery: "); /* Serial.print(adc_ain2_bat); Serial.print("  "); Serial.print(volts_bat); Serial.print("V\t"); */ Serial.print(amps_bat); Serial.print("A\tSoC: "); Serial.print(batSoC); Serial.println("%");
  Serial.print("Solar: "); /* Serial.print(adc_ain2_sol); Serial.print("  "); Serial.print(volts_sol); Serial.print("V\t"); */ Serial.print(amps_sol); Serial.print("A");
